const _base = (import.meta.env.VITE_API_URL as string) || (import.meta.env.VITE_API_BASE as string);
const API_BASE = _base ? _base.replace(/\/api\/?$/, '') + '/api' : "http://localhost:3000/api";
